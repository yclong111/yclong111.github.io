...
- Every photo gets a 1px white hairline: `::after` overlay on `.pp/.np/.flip-photo/.intro-photo`, a border on `img.slot-photo` (bottom of chapters.css). New photo wrappers need the same.
